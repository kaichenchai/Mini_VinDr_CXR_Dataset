...
python3 training_script.py \
  ...
  --batch_size 8 \
  --pretrained t \
  --run_name "pneumothorax_2_norm_200e_pretrained_vit_fixed" \
  --early_stop 50
...
python3 training_script.py \
  ...
  --batch_size 8 \
  --pretrained t \
  --run_name "pneumothorax_4_norm_200e_pretrained_vit_fixed" \
  --early_stop 50
...
python3 training_script.py \
  ...
  --batch_size 8 \
  --pretrained t \
  --run_name "pneumothorax_8_norm_200e_pretrained_vit_fixed" \
  --early_stop 50
...
python3 training_script.py \
  ...
  --batch_size 8 \
  --pretrained t \
  --run_name "pneumothorax_16_norm_200e_pretrained_vit_fixed" \
  --early_stop 50
